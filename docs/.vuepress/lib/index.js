!(function(t, e) {
    ...
    var E = {
        ...
        T = 'MicroMessenger' == j.match(/MicroMessenger/i),
        C = {
            isChrome: function() {
                return j.match(/Chrome/i)
            },
            isMobile: function() {
                return !!(j.match(/(iPhone|iPad|iPod)/i) || j.match(/Android/i) || j.match(/Windows Phone/i) || j.match(/IEMobile/i))
            },
            isIos: function() {
                return !!j.match(/(iPhone|iPad|iPod)/i)
            },
            isAndroid: function() {
                return !!j.match(/Android/i)
            },
            isWx: function() {
                return T && 'wxwork' != j.match(/wxwork/i)
            },
            isWxMobile: function() {
                return T && 'wxwork' != j.match(/wxwork/i) && 'Mobile' == j.match(/Mobile/i)
            },
            isWxPc: function() {
                return T && 'wxwork' != j.match(/wxwork/i) && 'Mobile' != j.match(/Mobile/i)
            },
        ...
        M = function() {
            return Array.from(arguments).reduce(function(t, e) {
                for (var n in e) t[n] = t[n] && '[object Object]' === t[n].toString() ? M(t[n], e[n]) : (t[n] = e[n])
                return t
            }, {})
        },
        N = {
        ...
        z = {
            ...
            downloadByBase64: m,
            downloadByImgLink: function(r, o, u, i) {
                return new Promise(function(n, e) {
                    var t = new Image()
                    ;(t.src = r),
                        (t.crossOrigin = 'anonymous'),
                        (t.onload = function() {
                            ;(u = u || this.width), (i = i || this.height)
                            var t = document.createElement('canvas'),
                                e = t.getContext('2d')
                            t.setAttribute('width', u), t.setAttribute('height', i), e.drawImage(this, 0, 0, u, i)
            ...
            downloadByImgSelector: function(t, u) {
                return new Promise(function(r, e) {
                    ...
                    o.setAttribute('crossOrigin', 'anonymous'),
                        (o.onload = function() {
                            ...
                            ;(n.download = u || 'defaultName'), (n.href = e), n.dispatchEvent(t), r()
                        }),
        ...
        R = J.setItem.bind(J),
        H = J.getItem.bind(J),
        W = J.removeItem.bind(J),
        q = JSON.stringify,
        U = {
            set: function(t, e) {
                if (F(t)) R(t, F(e) ? e : q(e))
                else if (v(t)) for (var n in t) R(n, F(t[n]) ? t[n] : q(t[n]))
            },
            get: function(t) {
                return F(t)
                    ? y(t)
            ...
            setExpired: function() {
                ...
                function r(t, e, n) {
                    R(t, q({ startTime: c, expiredTime: n, value: e }))
                }
                var o = e[0],
                    u = e[1],
                    i = e[2],
                    c = +new Date()
                if (1 == e.length) {
                    if (v(o)) for (var a in o) r(a, o[a], 0)
                } else if (2 == e.length) {
                    if (F(o)) r(o, 0, u)
                    else if (v(o) && b(u)) for (var l in o) r(l, o[l], Number(u))
                } else 3 == e.length && F(o) && b(i) && r(o, u, Number(i))
            },
            getExpired: function(t) {
                if (F(t)) {
                    var e = y(t)
                    return e && 'startTime' in e ? (new Date() - e.startTime > e.expiredTime ? (W(t), !1) : e.value) : null
                }
                for (var n = {}, r = 0; r < t.length; r++) {
                    var o,
                        u = t[r]
                    !F(u) || ((o = y(u)) && 'startTime' in o && (new Date() - o.startTime > o.expiredTime ? W(t) : (n[u] = o.value)))
                }
                return n
            },
            clearAll: function() {
            ...
            clearAllExpired: function() {
                for (var t = Object.keys(J).length, e = 0; e < t; e++) {
                    var n = y(k)
                    n && 'expiredTime' in n && W(k)
                }
            }
        },
        Y = sessionStorage,
        K = Y.getItem.bind(Y),
        X = Y.setItem.bind(Y),
        Q = Y.removeItem.bind(Y),
        _ = (Y.clear.bind(Y), JSON.stringify),
        G = Array.isArray,
        U = {
            local: U,
            session: {
                ...
                set: function(t, e) {
                    if (D(t)) X(t, _(e))
                        ...
                        for (var n = 0; n < t.length; n++) {
                            var r = t[n]
                            if (((u = r), '[object Object]' === Object.prototype.toString.call(u))) for (var o in r) X(o, D(r[o]) ? r[o] : _(r[o]))
                        }
                    var u
                },
                del: function(t) {
                ...
                each: function(t) {
                    for (var e = Object.keys(sessionStorage), n = 0; n < e.length; n++) t(e[n], w(e[n]))
                }
            }
        }
    return i(i(i(i(i(i(i(i(i(i(i({}, E), x), S), O), C), N), B), Z), L), z), U)
})
